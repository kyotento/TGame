...
namespace ExitGames
{
	namespace Common
	{
		...
		private:
			...
			template<typename Ctype>
			struct Stringifier<Helpers::SmartPointerBase<Ctype> >
			{
				static JString& toString(const JVector<Etype>& instance, JString& retStr, bool withTypes);
			};
		...
		{
			return Stringifier<Etype>::toString(*this, retStr, withTypes);
		}

		template<typename Etype>
		template<typename Ctype>
		JString& JVector<Etype>::Stringifier<Ctype>::toString(const JVector<Etype>& instance, JString& retStr, bool /*withTypes*/)
		{
		...
		template<typename Etype>
		template<typename Ctype>
		JString& JVector<Etype>::Stringifier<Helpers::SmartPointerBase<Ctype> >::toString(const JVector<Etype>& instance, JString& retStr, bool /*withTypes*/)
		{
			return retStr += Helpers::ToStringImplementation<Helpers::IsPrimitiveType<Ctype>::is, Etype>::converter.toString(instance.mpData, instance.getSize());
		}
	}
}